...
export default {
	...
	methods: {
		...
		async getAllDatasOfProtocol(selectedId, id) {
			...
			this.allDatas = [];
			await axios
				.get(`http://10.192.136.74:3000/stamp3drv/protocolDatas/${this.loadedId}`)
			...
			if (create) {
				switch (i) {
					...
					case 1:
						...
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolBoolean/${row.id}`;
						break;
					case 2:
					case 3:
						datas['type'] = row.type;
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolData/${row.id}`;
						break;
					case 4:
					case 5:
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolString/${row.id}`;
						break;
				}
				axios
				...
				switch (i) {
					...
					case 1:
						datas['complement'] = row.complement;
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolBoolean`;
						break;
					case 2:
					case 3:
						datas['type'] = row.type;
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolData`;
						break;
					case 4:
					case 5:
						queryString = `http://10.192.136.74:3000/stamp3drv/protocolString`;
						break;
				}
				axios
		...
		deleteRow(i, id) {
			...
			switch (i) {
				case 0:
				case 1:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolBoolean/${id}`;
					break;
				case 2:
				case 3:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolData/${id}`;
					break;
				case 4:
				case 5:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolString/${id}`;
					break;
			}
		...
		async updateDatas(i) {
			...
			switch (i) {
				case 0:
				case 1:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolBooleans/${id}`;
					break;
				case 2:
				case 3:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolDatas/${id}`;
					break;
				case 4:
				case 5:
					queryString = `http://10.192.136.74:3000/stamp3drv/protocolStrings/${id}`;
					break;
			}
			axios
				.get(queryString)
